...
export function filterItemsByAllergens(items, selectedAllergens) {
...
export function filterItemsByIntolerances(items, selectedIntolerances) {
...
export function filterItemsByDietary(items, selectedDietary) {
...
export function filterItemsBySpiceLevel(items, maxSpiceLevel) {
