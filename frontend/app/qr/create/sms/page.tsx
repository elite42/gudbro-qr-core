...
import { qrApi, SMSQRData, QRResponse } from '@/lib/api/qr';

export default function CreateSMSQRPage() {
  ...
  // Handle phone input - only accept digits
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data: SMSQRData = {
        phone: '+' + phone.trim(), // Add '+' prefix before sending
        message: message.trim(),
      };

      const qrResult = await qrApi.createSMS(data);
      setResult(qrResult);
    } catch (err: any) {
  ...
  const handleDownload = () => {
    ...
    link.download = `sms-qr-${result.id}.png`;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-black">SMS QR Code</h1>
                <p className="text-sm text-gray-600">
                  Create a QR code that opens a pre-filled text message
                </p>
              </div>
            </div>

            <div className="flex items-center gap-2 px-4 py-2 bg-blue-50 rounded-lg border border-blue-200">
              <LucideIcons.MessageSquare className="w-5 h-5 text-blue-600" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="text-lg font-bold mb-4 text-black">SMS Details</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-14 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black disabled:bg-gray-50 disabled:text-gray-500"
                    />
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
                    Enter country code + number (e.g., 1234567890 for US)
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    This message will be pre-filled when the QR code is scanned
                  </p>
                </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-700 text-sm">
                    When someone scans this QR code, their messaging app will open with
                    your phone number and message already filled in. They just need to hit send!
                  </p>
                </div>
              </div>
            </div>
              ...
              {!result ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-green-600 text-sm mt-1">
                        Your SMS QR code is ready to use
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex items-start gap-2">
                      <LucideIcons.MessageSquare className="w-4 h-4 text-gray-400 flex-shrink-0 mt-0.5" />
                      <div className="flex-1">
